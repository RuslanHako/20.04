...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Подключение к базе данных уже установлено в файле db.php, поэтому нет необходимости создавать новое соединение global $conn; // Используем глобальную переменную $conn из файла db.php
